# Note
This fork contains changes for the game to work better with NVidia's RTX Remix Framework. All the documentation and links present here, including Discord invite, are from the original author.

# Quake3e

[![build](../../workflows/build/badge.svg)](../../actions?query=workflow%3Abuild)<br>
Original author's Discord:
